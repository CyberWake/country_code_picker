...
class CountryCodePicker extends StatefulWidget {
  ...
  final Function(CountryCode?)? selectedCountryBuilder;
  final Function(CountryCode)? countryListBuilder;
  final bool enabled;
  final SelectionUIType show;
  ...
  const CountryCodePicker({
    ...
    this.show = SelectionUIType.dialog,
    Key? key,
  }) : super(key: key);
...
class CountryCodePickerState extends State<CountryCodePicker> {
    ...
    if (widget.selectedCountryBuilder != null) {
      internalWidget = InkWell(
        onTap: widget.enabled
            ? widget.show == SelectionUIType.dialog
                ? showCountryCodePickerDialog
                : () => showCountryCodePickerBottomSheet(context)
            : null,
        child: widget.selectedCountryBuilder!(selectedItem),
      );
    } else {
      ...
      builder: (context) => Center(
        child: Dialog(
          child: SelectionDialog(
            ...
            showCountryFirst: widget.showCountryFirst,
            ...
            countryListBuilder: widget.countryListBuilder,
          ),
        ),
      ),
    );
  ...
  void showCountryCodePickerBottomSheet(BuildContext inheritedContext) async {
    ...
    final item = await showModalBottomSheet<CountryCode?>(
...
enum SelectionUIType { dialog, bottomSheet }
